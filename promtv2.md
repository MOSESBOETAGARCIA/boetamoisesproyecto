...
Esta estructura evita eso desde el inicio.
...
NO metas lógica de negocio aquí.

---

## `data`

Firebase, modelos y repositorios.

Aquí vive la conexión con la base de datos.

---

## `domain`

La lógica real de la app.

Esta capa evita que termines dependiendo completamente de Firebase en todos lados.

---

## `presentation`

UI, pantallas y providers.

Aquí solo debería existir lógica visual y manejo de estado.
...
Esa estructura parece simple al inicio.

Luego el proyecto crece y:

* no encuentras nada,
* mezclas responsabilidades,
* repites código,
* y cualquier cambio rompe otras partes.

La diferencia entre una app amateur y una mantenible normalmente empieza en la estructura.
